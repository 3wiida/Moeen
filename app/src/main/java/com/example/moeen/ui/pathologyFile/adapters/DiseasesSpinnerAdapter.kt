...
import com.example.moeen.network.model.profileResponse.Disease

class DiseasesSpinnerAdapter(private val context: Context, private val list:MutableList<Disease>): BaseAdapter() {
